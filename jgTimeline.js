function generateTimeline(){
    ...
    //OriginalData to be used to go back to after transformations
    var jgOriginalData = [];
    ...
    //Domain Calculation:
    function jgDomain(data,property){
        var domain = [d3.min(data,function(d){return d[property];}),
...
//----------------------------------------
   ...
   d3.json("metaSteamGameList.json",function(d){
	...
	//Do whatever to the data here prior to binding
       ...
       //open:
       //filter by updated time > last played time
       //or, sort by playtime
       //or sort by aggregated playtime of genres
